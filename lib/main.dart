...
class _HomeState extends State<Home> {
  ...
  void _realChanged(String text) {
    ...
    bitController.text = (real / bit).toStringAsFixed(5);
  }
  ...
  void _dolarChanged(String text) {
    ...
    bitController.text = ((dolar * this.dolar) / bit).toStringAsFixed(5);
  }
  ...
  void _euroChanged(String text) {
    ...
    bitController.text = ((euro * this.euro) / bit).toStringAsFixed(5);
  }
...
buildTextField(
    String label, String prefixe, TextEditingController c, Function f) {
  return TextField(
    controller: c,
    onChanged: f,
